...
deps_drivers/net/ethernet/freescale/sdk_fman/src/wrapper/lnxwrp_fm.o := \
    $(wildcard include/config/FSL_FM_MAX_FRAME_SIZE) \
    $(wildcard include/config/FSL_FM_RX_EXTRA_HEADROOM) \
    $(wildcard include/config/FMAN_PFC) \
    $(wildcard include/config/FMAN_PFC_QUANTA_0) \
    $(wildcard include/config/FMAN_PFC_QUANTA_1) \
    $(wildcard include/config/FMAN_PFC_QUANTA_2) \
    $(wildcard include/config/FMAN_PFC_QUANTA_3) \
    $(wildcard include/config/EARLY_PRINTK) \
    $(wildcard include/config/PM_SLEEP) \
    $(wildcard include/config/FSL_SDK_FMAN_RTC_API) \
    $(wildcard include/config/PM) \
    $(wildcard include/config/FMAN_PFC_COS_COUNT) \
    $(wildcard include/config/PTP_1588_CLOCK_DPAA) \
  ...
  drivers/net/ethernet/freescale/sdk_fman/src/wrapper/lnxwrp_fm.h \
    $(wildcard include/config/FMAN_DISABLE_OH_TO_REUSE_RESOURCES) \
  ...
  drivers/net/ethernet/freescale/sdk_fman/src/inc/wrapper/lnxwrp_fm_ext.h \
    $(wildcard include/config/FSL_SDK_FMAN_TEST) \
  ...
  drivers/net/ethernet/freescale/sdk_fman/src/wrapper/lnxwrp_fm_port.h \
...
$(deps_drivers/net/ethernet/freescale/sdk_fman/src/wrapper/lnxwrp_fm.o):
#SYMVER FM_PORT_Disable 0x9d28e826
#SYMVER FM_PORT_Enable 0x367340a1
#SYMVER FM_PORT_SetPCD 0xf5fb212c
#SYMVER FM_PORT_DeletePCD 0x4ab78208
#SYMVER FM_PCD_Enable 0xe2f50392
#SYMVER FM_PCD_Disable 0x222c0f73
#SYMVER FM_PCD_GetCounter 0x52fb206e
#SYMVER FM_PCD_PrsLoadSw 0x54cb30ae
#SYMVER FM_PCD_KgSetDfltValue 0x6faa0379
#SYMVER FM_PCD_KgSetAdditionalDataAfterParsing 0x9e895919
#SYMVER FM_PCD_SetException 0x41fe8f5d
#SYMVER FM_PCD_ModifyCounter 0x4ad931ef
#SYMVER FM_PCD_SetPlcrStatistics 0x1ba51953
#SYMVER FM_PCD_SetPrsStatistics 0xa3369e20
#SYMVER FM_PCD_ForceIntr 0xcd761274
#SYMVER FM_PCD_AllowHcUsage 0xdf2f2d67
#SYMVER FM_PCD_HcTxConf 0x44700169
#SYMVER FM_PCD_NetEnvCharacteristicsSet 0x48e79aa9
#SYMVER FM_PCD_NetEnvCharacteristicsDelete 0x5fff3559
#SYMVER FM_PCD_KgSchemeSet 0xab758a50
#SYMVER FM_PCD_KgSchemeDelete 0x63a04042
#SYMVER FM_PCD_KgSchemeGetCounter 0x5a06feac
#SYMVER FM_PCD_KgSchemeSetCounter 0xb29a709e
#SYMVER FM_PCD_CcRootBuild 0x3a7cd600
#SYMVER FM_PCD_CcRootDelete 0xb7c2dd8b
#SYMVER FM_PCD_MatchTableSet 0x779688a9
#SYMVER FM_PCD_MatchTableDelete 0x065b861c
#SYMVER FM_PCD_CcRootModifyNextEngine 0x0ab6c87a
#SYMVER FM_PCD_MatchTableModifyNextEngine 0x9918613a
#SYMVER FM_PCD_MatchTableFindNModifyNextEngine 0xb3de891a
#SYMVER FM_PCD_MatchTableModifyMissNextEngine 0x6df674cb
#SYMVER FM_PCD_MatchTableRemoveKey 0x71658d51
#SYMVER FM_PCD_MatchTableFindNRemoveKey 0xa100857c
#SYMVER FM_PCD_MatchTableAddKey 0xa2c3b1ed
#SYMVER FM_PCD_MatchTableModifyKeyAndNextEngine 0x4dfe4a26
#SYMVER FM_PCD_MatchTableFindNModifyKeyAndNextEngine 0x72178f96
#SYMVER FM_PCD_MatchTableModifyKey 0x38fe5300
#SYMVER FM_PCD_MatchTableFindNModifyKey 0x50b49de5
#SYMVER FM_PCD_MatchTableGetIndexedHashBucket 0x9cc6cb9f
#SYMVER FM_PCD_MatchTableGetNextEngine 0xaea6f70a
#SYMVER FM_PCD_MatchTableGetKeyCounter 0x530f09db
#SYMVER FM_PCD_MatchTableGetKeyStatistics 0x3cf68424
#SYMVER FM_PCD_MatchTableFindNGetKeyStatistics 0x005dcdb6
#SYMVER FM_PCD_MatchTableGetMissStatistics 0x14e43d9f
#SYMVER FM_PCD_HashTableGetMissStatistics 0x14cc3266
#SYMVER FM_PCD_HashTableSet 0x42b93d75
#SYMVER FM_PCD_HashTableDelete 0x28c82aad
#SYMVER FM_PCD_HashTableAddKey 0x28a23dc2
#SYMVER FM_PCD_HashTableRemoveKey 0x6290be8d
#SYMVER FM_PCD_HashTableModifyNextEngine 0x72032371
#SYMVER FM_PCD_HashTableModifyMissNextEngine 0xe63fd8cb
#SYMVER FM_PCD_HashTableGetMissNextEngine 0x1ddec282
#SYMVER FM_PCD_HashTableFindNGetKeyStatistics 0x1aceaa5a
#SYMVER FM_PCD_PlcrProfileSet 0xc936cc24
#SYMVER FM_PCD_PlcrProfileDelete 0xf1366510
#SYMVER FM_PCD_PlcrProfileGetCounter 0xc619907a
#SYMVER FM_PCD_PlcrProfileSetCounter 0xed84bdc8
#SYMVER FM_PCD_ManipNodeSet 0x5af58255
#SYMVER FM_PCD_ManipNodeDelete 0x030f8b30
#SYMVER FM_PCD_ManipGetStatistics 0x03f94f08
#SYMVER FM_PCD_ManipNodeReplace 0xd489ef00
#SYMVER FM_PCD_FrmReplicSetGroup 0xa1a9d4c8
#SYMVER FM_PCD_FrmReplicDeleteGroup 0x2263c0bd
#SYMVER FM_PCD_FrmReplicAddMember 0xada723f0
#SYMVER FM_PCD_FrmReplicRemoveMember 0x9baac9e6
#SYMVER FM_PCD_SetAdvancedOffloadSupport 0xafad2e71
#SYMVER FM_MAC_GetStatistics 0x807f9b3d
#SYMVER FM_MAC_GetFrameSizeCounters 0x969fd0e1
#SYMVER FM_GetSpecialOperationCoding 0xb5a01d02
#SYMVER fm_get_max_frm 0x57c2a154
#SYMVER fm_get_rx_extra_headroom 0x4a0adee9
#SYMVER fm_has_errata_a050385 0x9e3c9e19
#SYMVER fm_bind 0x323516f7
#SYMVER fm_unbind 0x9cc99288
#SYMVER fm_get_mem_region 0xb16b99ea
#SYMVER fm_get_handle 0x168f02f9
#SYMVER fm_port_bind 0x85f4e1c3
#SYMVER fm_port_unbind 0xd2b7f9e3
#SYMVER fm_port_get_handle 0xe5ab0db3
#SYMVER fm_port_get_buffer_time_stamp 0xf2fadc8e
#SYMVER fm_port_pcd_bind 0x8e787954
#SYMVER fm_port_get_buff_layout_ext_params 0x2f80ed50
#SYMVER fm_get_tx_port_channel 0x2c60747f
#SYMVER fm_port_enable 0x76843c58
#SYMVER fm_port_disable 0x9a6a505d
#SYMVER fm_port_enable_rx_l4csum 0x77216ad1
#SYMVER fm_port_suspend 0x597d8fcc
#SYMVER fm_port_resume 0x04b2689e
#SYMVER fm_mac_set_exception 0x6beebe9b
#SYMVER fm_mac_free 0x6480daeb
#SYMVER fm_mac_config 0xa87c3427
#SYMVER fm_mac_config_max_frame_length 0xaaaf98d6
#SYMVER fm_mac_config_pad_and_crc 0x8ec79fec
#SYMVER fm_mac_config_half_duplex 0x7712d3a7
#SYMVER fm_mac_config_reset_on_init 0xbe21d979
#SYMVER fm_mac_init 0x22ac0f7c
#SYMVER fm_mac_get_version 0xd2860b4f
#SYMVER fm_mac_enable 0x9e0e9e9f
#SYMVER fm_mac_disable 0xc5dae2e3
#SYMVER fm_mac_resume 0x1a4179d6
#SYMVER fm_mac_set_promiscuous 0x5e938db1
#SYMVER fm_mac_remove_hash_mac_addr 0x07b32d30
#SYMVER fm_mac_add_hash_mac_addr 0xddf8f6a5
#SYMVER fm_mac_modify_mac_addr 0xfce23ec1
#SYMVER fm_mac_adjust_link 0x99f72991
#SYMVER fm_mac_enable_1588_time_stamp 0xa44a39bc
#SYMVER fm_mac_disable_1588_time_stamp 0xcc300993
#SYMVER fm_mac_set_rx_pause_frames 0x7bdb8931
#SYMVER fm_mac_set_tx_pause_frames 0x26e14bd6
#SYMVER fm_mac_set_wol 0x7f7ec8b9
#SYMVER fm_mutex_lock 0x4484c9f6
#SYMVER fm_mutex_unlock 0x0f9316c8
